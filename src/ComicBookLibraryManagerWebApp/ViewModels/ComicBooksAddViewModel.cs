...
namespace ComicBookLibraryManagerWebApp.ViewModels
{
        ...
        : ComicBooksBaseViewModel
    {
        ...
        /// </summary>
        public override void Init(Repository repository,ArtistRepository artistRepository,SeriesRepository seriesRepository)
        {
            base.Init(repository, artistRepository,seriesRepository);
